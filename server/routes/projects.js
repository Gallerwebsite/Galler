...
async function getSubmissions() {
  return (await readJSON('project-submissions.json')) || [];
}

async function saveSubmissions(data) {
  await writeJSON('project-submissions.json', data);
}
...
router.post(
  ...
  async (req, res) => {
    ...
    const { fullName, companyName, email, phone, subject, details } = req.body;
